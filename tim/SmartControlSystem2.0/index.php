...
<html lang="zh-CN">
	...
	<body>
		<div class="col-md-6" style="margin: 20px;">
			...
			<button class="btn btn-success btn-lg btn-block" type="button" onclick="light(3)">HIGH</button><br>
			<button class="btn btn-success btn-lg btn-block" type="button" onclick="light(2)">MID</button><br>
			<button class="btn btn-success btn-lg btn-block" type="button" onclick="light(1)">LOW</button><br>
			<button class="btn btn-success btn-lg btn-block" type="button" onclick="light(0)">OFF</button><br>
			<div id="returndata"></div>
			<div>Powered By YullionStudio</div>
		</div>
	</body>
</html>
